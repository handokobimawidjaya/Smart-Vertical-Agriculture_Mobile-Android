...
public class LineDistance extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener {
...
// found in the TurfConstants class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_line_distance );
...
// DISTANCE_UNITS must be equal to a String found in the TurfConstants class
        ...
        LineDistance.this.mapboxMap = mapboxMap;
...
// Style and add the LineLayer to the map. The LineLayer is placed below the CircleLayer.
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        LineDistance.this.mapboxMap.addOnMapClickListener(LineDistance.this);
                        Toast.makeText(LineDistance.this, getString(
